# This script iterates through all image files (jpg, jpeg, png) in a specified local directory
# and uses the BLIP-2 vision-language model to generate a descriptive caption for each image.
# The resulting captions are then written to a file named 'captions.txt', paired with their original filename.
