# This script scrapes all images from a specified Wikipedia URL (IBM in this case),
# downloads them in memory, generates descriptive captions for each using the
# BLIP vision-language model, and saves the results (URL and caption)
# to a file named 'captions.txt'.
